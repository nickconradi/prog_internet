...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($lado1 + $lado2 > $lado3 && $lado1 + $lado3 > $lado2 && $lado2 + $lado3 > $lado1) {
        if ($lado1 == $lado2 && $lado2 == $lado3) {
            echo "<p>Triângulo é Equilátero (todos lados são iguais).</p>";
        } elseif ($lado1 == $lado2 || $lado2 == $lado3 || $lado1 == $lado3) {
            echo "<p>Triângulo é Isósceles (dois lados são iguais).</p>";
        } else {
            echo "<p>Triângulo é Escaleno (todos lados são diferentes).</p>";
        }
    } else {
